...
ID_ESTUDIANTE INT,
FOREIGN KEY (ID_FACULTAD) REFERENCES TBL_ESTUDIANTE(ID_ESTUDIANTE),
FOREIGN KEY (ID_FACULTAD) REFERENCES TBL_FACULTAD(ID_FACULTAD)
);
SELECT * FROM TBL_CURSOS;
select * from TBL_CURSOS where ID_CURSOS
...
#se quita la referencia de cursos para un mejor control
